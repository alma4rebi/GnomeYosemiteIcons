...
wget https://github.com/ActusOS/GnomeYosemiteIcons/archive/master.zip
unzip -o master.zip
else
echo Cloning from GitHub repository.
git clone https://github.com/ActusOS/GnomeYosemiteIcons.git GnomeYosemiteIcons-master
fi
